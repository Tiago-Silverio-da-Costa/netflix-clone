...
export default function Navbar() {
  ...
  return (
    <div className="w-ful max-7xl mx-auto items-center justify-between px-5 sm:px-6 py-5 lg:px-8 flex">
      <div className="flex items-center">
        <Link href="/home" className="w-32">
          <Image src={Logo} width={120} height={120} alt="Netflix logo" priority />
        </Link>
